...
return new class extends Migration
{
     ...
     * Run the migrations.
     *
     * Ledger of every device-to-employee assignment, mirroring
     * sim_assignments. An open row (returned_at null) means the device is
    ...
    public function up(): void
    {
        Schema::create('device_assignments', function (Blueprint $table) {
            ...
            $table->index(['device_id', 'assigned_at']);
